...
\subsection{Das Puls"=NMR"=Spektrometer}
 \begin{figure}[htp]
	$$\includegraphics{drawings/NMR-Setup}$$
%	$$\includegraphics[bb=0 0 536 250,width=0.9\textwidth]{drawings/NMR-Setup.eps}$$
...
\subsection{Die NMR"=Probe}
 \begin{figure}[htp]
	$$\includegraphics{drawings/probe}$$
%	$$\includegraphics[bb=0 0 408 208]{drawings/probe.eps}$$
...
\begin{figure}[htp]
	$$\includegraphics{drawings/relaxation}$$
%	$$\includegraphics[bb=0 0 277 77,scale=1.44]{drawings/Relaxation.eps}$$
...
HF"=Puls erhält man die intrinsische Spin"=Spin Relaxationzeit $T_2$.
 ...
 \begin{figure}[htp]
	$$\includegraphics{drawings/T2Messung}$$
%	$$\includegraphics[bb=0 0 380 160]{drawings/t2messung.eps}$$
